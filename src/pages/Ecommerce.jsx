...
const Ecommerce = () => {
  ...
  return (
    ...
    {earningData.map((item)=>(
      <div key={item.title} className='bg-white dark:text-gray-400 dark:bg-secondary-dark-bg md:w-56 p-5 pt-9 rounded-2xl'>
     ...
     <div className='mx-5  p-3 my-5 bg-white rounded-lg'>
      ...
      <div className='flex md:w-1/2 w-full flex-col border-r mx-5'>
       ...
       <div className='flex items-center mt-5'>
        ...
        <small className='bg-green-400 py-[3px] px-[6px] rounded-full mx-2 text-white mt-2'>34%</small>
       </div>
       <div>
